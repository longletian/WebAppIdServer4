...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        if (!string.IsNullOrWhiteSpace(provider))
        {
            ...
            {
                case "GitHub":
                    userIdClaim = externalUser.Claims.Where((p) => p.Type == "id").FirstOrDefault();
        ...
        SignInResult signInResult = await signInManager.ExternalLoginSignInAsync(provider, providerUserId, true);
